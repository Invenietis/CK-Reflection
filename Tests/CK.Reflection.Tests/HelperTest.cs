...
namespace CK.Reflection.Tests
{
    ...
    public class HelperTest
    {
        ...
        public void Parameters()
        {
            ...
            MethodInfo m = typeof( HelperTest ).GetMethod( nameof( HelperTest.JustForTest ), bindingJustForTest );
            {
            ...
            {
                Type[] p = ReflectionHelper.CreateParametersType( m.GetParameters(), typeof( IA ) );
                p[0].Should().BeSameAs( typeof( IA ) );
